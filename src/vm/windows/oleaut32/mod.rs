...
pub fn register(vm: &mut Vm) {
    ...
    vm.register_import_stdcall(DLL_NAME, "SysAllocString", crate::vm::stdcall_args(1), sys_alloc_string);
    vm.register_import_stdcall(DLL_NAME, "SysAllocStringLen", crate::vm::stdcall_args(2), sys_alloc_string_len);
    vm.register_import_stdcall(DLL_NAME, "SysFreeString", crate::vm::stdcall_args(1), sys_free_string);
    vm.register_import_stdcall(DLL_NAME, "SysStringLen", crate::vm::stdcall_args(1), sys_string_len);
    vm.register_import_stdcall(DLL_NAME, "SysStringByteLen", crate::vm::stdcall_args(1), sys_string_byte_len);
    ...
    vm.register_import_stdcall(DLL_NAME, "VariantInit", crate::vm::stdcall_args(1), variant_init);
    vm.register_import_stdcall(DLL_NAME, "VariantClear", crate::vm::stdcall_args(1), variant_clear);
    vm.register_import_stdcall(
        DLL_NAME,
        "VariantChangeType",
    ...
    vm.register_import_stdcall(DLL_NAME, "SafeArrayCreate", crate::vm::stdcall_args(3), safe_array_create);
    vm.register_import_stdcall(
        DLL_NAME,
        "SafeArrayAccessData",
        crate::vm::stdcall_args(2),
    ...
    vm.register_import_stdcall(DLL_NAME, "LoadTypeLib", crate::vm::stdcall_args(2), load_type_lib);
    vm.register_import_stdcall(DLL_NAME, "LoadRegTypeLib", crate::vm::stdcall_args(5), load_reg_type_lib);
    vm.register_import_stdcall(DLL_NAME, "RegisterTypeLib", crate::vm::stdcall_args(3), register_type_lib);
    vm.register_import_stdcall(DLL_NAME, "UnRegisterTypeLib", crate::vm::stdcall_args(5), unregister_type_lib);
    ...
    vm.register_import_stdcall(DLL_NAME, "VarUI4FromStr", crate::vm::stdcall_args(4), var_ui4_from_str);
    vm.register_import_stdcall(DLL_NAME, "VarBstrCat", crate::vm::stdcall_args(3), var_bstr_cat);
