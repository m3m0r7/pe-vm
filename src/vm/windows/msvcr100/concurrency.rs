...
define_stub_fn!(DLL, concurrency_alloc, 0);
define_stub_fn!(DLL, concurrency_free, 0);
define_stub_fn!(DLL, context_block, 0);
define_stub_fn!(DLL, context_current_context, 0);
define_stub_fn!(DLL, context_id, 0);
define_stub_fn!(DLL, context_is_current_task_collection_canceling, 0);
define_stub_fn!(DLL, context_oversubscribe, 0);
define_stub_fn!(DLL, context_schedule_group_id, 0);
define_stub_fn!(DLL, context_virtual_processor_id, 0);
define_stub_fn!(DLL, context_yield, 0);
define_stub_fn!(DLL, current_scheduler_create, 0);
define_stub_fn!(DLL, current_scheduler_detach, 0);
define_stub_fn!(DLL, current_scheduler_get, 0);
define_stub_fn!(DLL, current_scheduler_get_number_of_virtual_processors, 0);
define_stub_fn!(DLL, current_scheduler_get_policy, 0);
define_stub_fn!(DLL, current_scheduler_id, 0);
define_stub_fn!(DLL, current_scheduler_create_schedule_group, 0);
define_stub_fn!(DLL, current_scheduler_register_shutdown_event, 0);
define_stub_fn!(DLL, current_scheduler_schedule_task, 0);
define_stub_fn!(DLL, scheduler_create, 0);
define_stub_fn!(DLL, scheduler_set_default_scheduler_policy, 0);
define_stub_fn!(DLL, scheduler_reset_default_scheduler_policy, 0);
define_stub_fn!(DLL, scheduler_policy_ctor, 0);
define_stub_fn!(DLL, scheduler_policy_dtor, 0);
define_stub_fn!(DLL, scheduler_policy_get_policy_value, 0);
define_stub_fn!(DLL, scheduler_policy_set_policy_value, 0);
define_stub_fn!(DLL, scheduler_policy_set_concurrency_limits, 0);
define_stub_fn!(DLL, critical_section_ctor, 0);
define_stub_fn!(DLL, critical_section_dtor, 0);
define_stub_fn!(DLL, critical_section_lock, 0);
define_stub_fn!(DLL, critical_section_try_lock, 0);
define_stub_fn!(DLL, critical_section_unlock, 0);
define_stub_fn!(DLL, critical_section_native_handle, 0);
define_stub_fn!(DLL, reader_writer_lock_ctor, 0);
define_stub_fn!(DLL, reader_writer_lock_dtor, 0);
define_stub_fn!(DLL, reader_writer_lock_lock, 0);
define_stub_fn!(DLL, reader_writer_lock_lock_read, 0);
define_stub_fn!(DLL, reader_writer_lock_try_lock, 0);
define_stub_fn!(DLL, reader_writer_lock_try_lock_read, 0);
define_stub_fn!(DLL, reader_writer_lock_unlock, 0);
define_stub_fn!(DLL, event_ctor, 0);
define_stub_fn!(DLL, event_dtor, 0);
define_stub_fn!(DLL, event_set, 0);
define_stub_fn!(DLL, event_reset, 0);
define_stub_fn!(DLL, event_wait, 0);
define_stub_fn!(DLL, event_wait_for_multiple, 0);
define_stub_fn!(DLL, spin_lock_ctor, 0);
define_stub_fn!(DLL, spin_lock_dtor, 0);
define_stub_fn!(DLL, spin_lock_lock, 0);
define_stub_fn!(DLL, spin_lock_try_lock, 0);
define_stub_fn!(DLL, spin_lock_unlock, 0);
define_stub_fn!(DLL, spin_wait_ctor, 0);
define_stub_fn!(DLL, spin_wait_spin_once, 0);
define_stub_fn!(DLL, spin_wait_reset, 0);
define_stub_fn!(DLL, task_collection_ctor, 0);
define_stub_fn!(DLL, task_collection_dtor, 0);
define_stub_fn!(DLL, task_collection_cancel, 0);
define_stub_fn!(DLL, task_collection_is_canceling, 0);
define_stub_fn!(DLL, task_collection_run_and_wait, 0);
define_stub_fn!(DLL, task_collection_schedule, 0);
define_stub_fn!(DLL, structured_task_collection_ctor, 0);
define_stub_fn!(DLL, structured_task_collection_dtor, 0);
define_stub_fn!(DLL, structured_task_collection_cancel, 0);
define_stub_fn!(DLL, structured_task_collection_is_canceling, 0);
define_stub_fn!(DLL, structured_task_collection_run_and_wait, 0);
define_stub_fn!(DLL, structured_task_collection_schedule, 0);
...
pub fn register(vm: &mut Vm) {
    ...
    vm.register_import(
        ...
        context_schedule_group_id,
    );
    vm.register_import(
        DLL,
        "?VirtualProcessorId@Context@Concurrency@@SAIXZ",
        context_virtual_processor_id,
    );
    ...
    vm.register_import(
        ...
        current_scheduler_create,
    );
    vm.register_import(
        DLL,
        "?Detach@CurrentScheduler@Concurrency@@SAXXZ",
        current_scheduler_detach,
    );
    vm.register_import(
        DLL,
        "?Get@CurrentScheduler@Concurrency@@SAPAVScheduler@2@XZ",
        current_scheduler_get,
    );
    vm.register_import(
        DLL,
        "?GetNumberOfVirtualProcessors@CurrentScheduler@Concurrency@@SAIXZ",
        current_scheduler_get_number_of_virtual_processors,
    );
    vm.register_import(
        DLL,
        "?GetPolicy@CurrentScheduler@Concurrency@@SA?AVSchedulerPolicy@2@XZ",
        current_scheduler_get_policy,
    );
    vm.register_import(
        DLL,
    ...
    vm.register_import(
        ...
        scheduler_set_default_scheduler_policy,
    );
    vm.register_import(
        DLL,
        "?ResetDefaultSchedulerPolicy@Scheduler@Concurrency@@SAXXZ",
        scheduler_reset_default_scheduler_policy,
    );
    ...
    vm.register_import(
        ...
        reader_writer_lock_ctor,
    );
    vm.register_import(
        DLL,
        "??1reader_writer_lock@Concurrency@@QAE@XZ",
        reader_writer_lock_dtor,
    );
    vm.register_import(
        DLL,
    ...
    vm.register_import(
        DLL,
        "?_Acquire@_SpinLock@details@Concurrency@@QAEXXZ",
        spin_lock_lock,
    );
    vm.register_import(
        DLL,
        "?_TryAcquire@_SpinLock@details@Concurrency@@QAE_NXZ",
        spin_lock_try_lock,
    );
    vm.register_import(
        DLL,
        "?_Release@_SpinLock@details@Concurrency@@QAEXXZ",
        spin_lock_unlock,
    );
    ...
    vm.register_import(
        ...
        task_collection_schedule,
    );

    // _StructuredTaskCollection
    vm.register_import(
        DLL,
        "??0_StructuredTaskCollection@details@Concurrency@@QAE@XZ",
        structured_task_collection_ctor,
    );
    vm.register_import(
        DLL,
        "??1_StructuredTaskCollection@details@Concurrency@@QAE@XZ",
        structured_task_collection_dtor,
    );
    vm.register_import(
        DLL,
        "?_Abort@_StructuredTaskCollection@details@Concurrency@@AAEXXZ",
        structured_task_collection_cancel,
    );
    vm.register_import(
        DLL,
    ...
    vm.register_import(
        ...
        structured_task_collection_is_canceling,
    );
    ...
    vm.register_import(
        ...
        structured_task_collection_schedule,
    );
