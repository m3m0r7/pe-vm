...
pub fn register(vm: &mut Vm) {
    ...
    vm.register_import(DLL, "CreatePerlObject", create_perl_object);
    vm.register_import(DLL, "SetSVFromVariant", set_sv_from_variant);
    vm.register_import(DLL, "SetSVFromVariantEx", set_sv_from_variant_ex);
    vm.register_import(DLL, "SetVariantFromSV", set_variant_from_sv);
    vm.register_import(DLL, "_boot_Win32__OLE", boot_win32_ole);
    vm.register_import(DLL, "boot_Win32__OLE", boot_win32_ole);
}
