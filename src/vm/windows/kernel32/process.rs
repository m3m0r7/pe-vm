...
pub fn register(vm: &mut Vm) {
    ...
    vm.register_import_stdcall(DLL_NAME, "GetStartupInfoA", crate::vm::stdcall_args(1), get_startup_info_a);
    ...
    vm.register_import_stdcall(DLL_NAME, "SetHandleCount", crate::vm::stdcall_args(1), set_handle_count);
}
