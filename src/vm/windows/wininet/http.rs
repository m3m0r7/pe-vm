...
use super::utils::{network_fallback_host, normalize_host, read_c_string, read_optional_bytes, read_optional_string};
...
pub(super) fn internet_set_option_a(_vm: &mut Vm, _stack_ptr: u32) -> u32 {
    1
}
